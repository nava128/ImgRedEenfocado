...
class _MyHomePageState extends State<MyHomePage> {
          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                ...
                margin: EdgeInsets.symmetric(vertical: isWideScreen() ? 20.0 : 0),
                child: TextFormField(
              ...
              TextButton(
                ...
                child: Container(
                  child: Text(
                    ...
                    style: TextStyle(fontSize: isWideScreen() ? 30.0 : 18.0, color: Colors.white),
                  ),
  ...
  Widget _buildNoteTile(Note n, Function(Note) onTab) {
    final width = MediaQuery.of(context).size.width;
    return Container(
      padding: EdgeInsets.symmetric(horizontal: isWideScreen() ? width * 0.2 : 10.0),
      child: ListTile(
        onTap: () => onTab(n),
        title: Text(
          n.title,
          style: TextStyle(
            ...
            decoration: n.completed ? TextDecoration.lineThrough : TextDecoration.none,
          ),
        ),
        leading: Icon(
          //n.completed ? Icons.circle : Icons.circle_outlined,
          n.completed ? Icons.circle : Icons.circle,
          color: Colors.white,
        ),
      ),
    );
